<form action="{{ route('publishers.destroy', $id) }}" method="POST" class="text-center">
    @csrf
    @method('DELETE')

    <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" href="{{ route('publishers.show', $id) }}" >
    ...
    <a class="btn btn-icon btn-bg-light btn-active-color-warning btn-sm me-1" href="{{ route('publishers.edit', $id) }}" >
