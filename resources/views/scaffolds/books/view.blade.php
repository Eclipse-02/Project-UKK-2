...
<div class="card card-xxl-stretch">
    ...
    <div class="card-body pt-5">
        ...
        <div class="row mb-10">
            ...
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->desc }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            ...
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->isbn }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-10">
            <!--begin::Label-->
            <label class="col-lg-4 fw-bold text-muted">Release Year</label>
            <!--begin::Label-->
            <!--begin::Label-->
            <div class="col-lg-8">
                <span class="fw-bold fs-6 text-gray-800">{{ $data->year }}</span>
            </div>
            <!--begin::Label-->
        </div>
        <!--end::Input group-->
